...
export function ReporteCompras() {
    ...
    const descripcion = "Historial de compras y proveedores.";
    ...
    const construirURL = () => {
        ...
        return `${baseUrl}/reportes/compras?${query.toString()}`;
    };
    ...
    const descargarPDF = () => {
        if (pdfUrl) {
            ...
            link.href = pdfUrl;
            link.download = `reporte-compras-${new Date().toISOString().split('T')[0]}.pdf`;
                    ...
                    <div className="px-4 py-2 bg-neutral-100 dark:bg-neutral-800 border-b">
                        <div className="flex items-center justify-between">
                            <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">
                                Reporte de Compras - {new Date().toLocaleDateString()}
                            </span>

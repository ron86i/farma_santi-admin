...
import { DialogHabilitarCategoria } from "./DialogHabilitarCategoria";
import { DialogDeshabilitarCategoria } from "./DialogDeshabilitarCategoria";
...
export function MenuAcciones({ categoriaId: categoriaId, deletedAt }: MenuAccionesProps) {
  ...
  return (
    <>
      ...
      {openDialogHabilitar && 
        <DialogHabilitarCategoria open={openDialogHabilitar} onClose={() => { setOpenDialogHabilitar(false) }} deletedAt={deletedAt!!} categoriaId={categoriaId} />
      }
      {openDialogDeshabilitar && 
        <DialogDeshabilitarCategoria open={openDialogDeshabilitar} onClose={() => { setOpenDialogDeshabilitar(false) }} categoriaId={categoriaId} />
      }
    </>
  );
}
